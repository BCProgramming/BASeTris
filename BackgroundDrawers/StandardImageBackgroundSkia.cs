...
namespace BASeTris.BackgroundDrawers
{
    ...
    public class StandardImageBackgroundSkia : Background<StandardImageBackgroundDrawSkiaCapsule>
    {
        ...
        public static StandardImageBackgroundSkia GetMenuBackgroundDrawer()
        {
            ...
            {
                NominoTheme chosen = TetrisGame.Choose<Func<NominoTheme>>(new Func<NominoTheme>[] { () => new GameBoyTetrominoTheme(), () => new SNESTetrominoTheme(), () => new NESTetrominoTheme(), () => new StandardTetrominoTheme(), () => new Tetris2Theme_Standard(), () => new Tetris2Theme_Enhanced(), () => new GameBoyMottledTheme(),() => new SNESTetris2Theme() })();
