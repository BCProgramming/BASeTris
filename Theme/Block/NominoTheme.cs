...
namespace BASeTris
{
    ...
    public abstract class NominoTheme
    {
        ...
        {
            return new Func<NominoTheme>[] { ()=>new GameBoyPixelTheme(), ()=>new TetrisDXTheme(),()=>new TetrisDX_Mottled(),  () => new SNESTetris3Theme(), () => new GameBoyTetrominoTheme(), () => new SNESTetrominoTheme(), () => new NESTetrominoTheme(), () => new StandardTetrominoTheme(), () => new NESTetris2Theme(), () => new SNESTetris2Theme(), () => new GameBoyMottledTheme() };
        }
