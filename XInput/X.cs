// Was going to bring in the newest version of this library, but couldn't figure out how to do FFB_Vibrate and
// I wasn't going to stub out something that has no business NOT being implemented in a new version of the same lib!
// Probably some weird new way of doing it, but I figure I can deal with that later- main thing is that the Nuget package isn't compatible with .NET Core which caused a lot of issues.
